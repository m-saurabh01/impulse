...
<head>
    ...
    <title>Page Not Found - PulseMail</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        body::before {
            ...
            background: radial-gradient(ellipse at 30% 20%, rgba(243, 156, 18, 0.1) 0%, transparent 50%),
...
<div class="error-container">
    <div class="error-card">
        ...
        <div class="error-actions">
            ...
            <a href="${pageContext.request.contextPath}/mail/compose" class="btn-secondary-custom">
